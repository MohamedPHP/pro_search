            ...
            <div class="card-content">
                ...
                <form method="post" action="{{ route('company.create') }}">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4">
                            <input type="email" class="form-control input" id="username" name="username" value="{{ old('username') }}" required autocomplete="off">
                        </div>
                    </div>
                    {{-- End email --}}
                    {{-- Start business_type --}}
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control input" id="phones" name="phones" value="{{ old('phones') }}" required autocomplete="off">
